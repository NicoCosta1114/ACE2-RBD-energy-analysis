...
Figure~\ref{fig:top10_destabilizing} shows the ten interface residues with the strongest destabilizing
contributions to the ACE2–RBD interaction, as obtained from the per-residue interaction
energy decomposition of the wild-type complex. These residues with positive interaction 
energies contribute most unfavourably to binding.
